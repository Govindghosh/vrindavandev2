...
if (!content.includes('SquigglyText')) {
  ...
  content = content.replace(
    ...
    '<SquigglyText scale={[2, 4]} stepDuration={80} className="block bg-gradient-to-r from-gold-primary via-gold-light to-gold-primary bg-clip-text text-transparent">DEV</SquigglyText>'
  );
